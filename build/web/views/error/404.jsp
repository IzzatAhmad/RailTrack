...
<html>
    ...
    <body class="bg-white">
        <div class="min-vh-100 d-flex align-items-center justify-content-center text-center">
            <div>
                <img src="<%= request.getContextPath()%>/img/railway.gif"
                    alt="RailTrack"
                    style="width: 128px; height: 128px; object-fit: cover; border-radius: 50%"/>
                <p class="display-6 fw-bold mt-3">Oops! We’ve gone off the rails.</p>
                <p class="lead text-muted">Reload the page, or contact support to clear the tracks.</p>
                <button type="button" onclick="refresh()" class="btn btn-primary">Try again</button>
                <button type="button" class="btn btn-dark"onclick="home()">Go Home</button>
            </div>
        </div>
    </body>
</html>
